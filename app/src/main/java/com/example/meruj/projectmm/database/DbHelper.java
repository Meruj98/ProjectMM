package com.example.meruj.projectmm.database;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_ANKAP_BAN = "ankap ban";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_USERS_TABLE = "CREATE TABLE " + TABLE_USERS + "("
                ...
                + KEY_PASSWORD + " TEXT," + KEY_USER_EMAIL + " TEXT" + ")";

        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_CONTACT_NAME + " TEXT,"
                + KEY_PH_NO + " TEXT," + KEY_USER_NAME + " TEXT" + ")";
    ...
    public void addContact(Contact contact) {
        ...
        values.put(KEY_USER_NAME, contact.getUserName()); // Contact Phone
    ...
    public void addUser(User user) {
        ...
        values.put(KEY_USER_EMAIL, user.getEmail()); // Contact Phone
    ...
    User getUser(int id) {
        ...
        Cursor cursor = db.query(TABLE_USERS, new String[]{KEY_USER_ID,
                        KEY_NAME, KEY_PASSWORD, KEY_USER_EMAIL}, KEY_USER_ID + "=?",
    ...
    public boolean ifUserAdded(String email) {
        SQLiteDatabase db = this.getReadableDatabase();

        Cursor cursor = db.query(TABLE_USERS, new String[]{KEY_USER_ID,
                        KEY_NAME, KEY_PASSWORD, KEY_USER_EMAIL}, KEY_USER_EMAIL + "=?",
        ...
        try {
            cursor.getString(0);
            return true;
        } catch (CursorIndexOutOfBoundsException anun) {
            return false;
        }
    ...
    public boolean ifPasswordTrue(String email, String password) {
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        return (cursor.getString(2).equals(password));
    ...
    Contact getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[]{KEY_ID,
                        KEY_CONTACT_NAME, KEY_PH_NO, KEY_USER_NAME}, KEY_ID + "=?",
                new String[]{String.valueOf(id)}, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
